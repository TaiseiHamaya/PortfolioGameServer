...
// This variable must not be referenced except by protobuf generated
// code.
pub(crate) static mut Proto__Quaternion_msg_init: ::protobuf::__internal::runtime::MiniTablePtr =
    ::protobuf::__internal::runtime::MiniTablePtr(::std::ptr::null_mut());
#[allow(non_camel_case_types)]
pub struct Quaternion {
  inner: ::protobuf::__internal::runtime::OwnedMessageInner<Quaternion>
}
...
impl ::protobuf::Parse for Quaternion {
  fn parse(serialized: &[u8]) -> ::std::result::Result<Self, ::protobuf::ParseError> {
    Self::parse(serialized)
  }
...
impl ::protobuf::Serialize for Quaternion {
  fn serialize(&self) -> ::std::result::Result<Vec<u8>, ::protobuf::SerializeError> {
    ::protobuf::AsView::as_view(self).serialize()
  }
}
...
// SAFETY:
// - `Quaternion` is `Sync` because it does not implement interior mutability.
//    Neither does `QuaternionMut`.
unsafe impl Sync for Quaternion {}

// SAFETY:
// - `Quaternion` is `Send` because it uniquely owns its arena and does
//   not use thread-local data.
unsafe impl Send for Quaternion {}

impl ::protobuf::Proxied for Quaternion {
  type View<'msg> = QuaternionView<'msg>;
}

impl ::protobuf::__internal::SealedInternal for Quaternion {}

impl ::protobuf::MutProxied for Quaternion {
  type Mut<'msg> = QuaternionMut<'msg>;
}

#[derive(Copy, Clone)]
#[allow(dead_code)]
pub struct QuaternionView<'msg> {
  inner: ::protobuf::__internal::runtime::MessageViewInner<'msg, Quaternion>,
  _phantom: ::std::marker::PhantomData<&'msg ()>,
}

impl<'msg> ::protobuf::__internal::SealedInternal for QuaternionView<'msg> {}

impl<'msg> ::protobuf::MessageView<'msg> for QuaternionView<'msg> {
  type Message = Quaternion;
}

impl ::std::fmt::Debug for QuaternionView<'_> {
  fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
    let string = unsafe {
      ::protobuf::__internal::runtime::debug_string(
        self.raw_msg(),
...
impl ::protobuf::Serialize for QuaternionView<'_> {
  fn serialize(&self) -> ::std::result::Result<Vec<u8>, ::protobuf::SerializeError> {
    // SAFETY: `MINI_TABLE` is the one associated with `self.raw_msg()`.
    let encoded = unsafe {
      ::protobuf::__internal::runtime::wire::encode(self.raw_msg(),
...
impl ::std::default::Default for QuaternionView<'_> {
  fn default() -> QuaternionView<'static> {
    let inner = unsafe { ::protobuf::__internal::runtime::MessageViewInner::wrap_raw(::protobuf::__internal::runtime::ScratchSpace::zeroed_block()) };
    QuaternionView::new(::protobuf::__internal::Private, inner)
  }
}

#[allow(dead_code)]
impl<'msg> QuaternionView<'msg> {
  #[doc(hidden)]
  pub fn new(_private: ::protobuf::__internal::Private, inner: ::protobuf::__internal::runtime::MessageViewInner<'msg, Quaternion>) -> Self {
    Self { inner, _phantom: ::std::marker::PhantomData }
  }
  ...
  pub fn to_owned(&self) -> Quaternion {
    ::protobuf::IntoProxied::into_proxied(*self, ::protobuf::__internal::Private)
  }
...
// SAFETY:
// - `QuaternionView` is `Sync` because it does not support mutation.
unsafe impl Sync for QuaternionView<'_> {}

// SAFETY:
// - `QuaternionView` is `Send` because while its alive a `QuaternionMut` cannot.
// - `QuaternionView` does not use thread-local data.
unsafe impl Send for QuaternionView<'_> {}

impl<'msg> ::protobuf::Proxy<'msg> for QuaternionView<'msg> {}
impl<'msg> ::protobuf::ViewProxy<'msg> for QuaternionView<'msg> {}

impl<'msg> ::protobuf::AsView for QuaternionView<'msg> {
  type Proxied = Quaternion;
  fn as_view(&self) -> ::protobuf::View<'msg, Quaternion> {
    *self
  }
}

impl<'msg> ::protobuf::IntoView<'msg> for QuaternionView<'msg> {
  fn into_view<'shorter>(self) -> QuaternionView<'shorter>
  where
      'msg: 'shorter {
    self
  }
...
impl<'msg> ::protobuf::IntoProxied<Quaternion> for QuaternionView<'msg> {
  fn into_proxied(self, _private: ::protobuf::__internal::Private) -> Quaternion {
    let mut dst = Quaternion::new();
    let dst_raw = ::protobuf::__internal::runtime::UpbGetMessagePtrMut::get_raw_message_mut(&mut dst, ::protobuf::__internal::Private);
    let dst_arena = ::protobuf::__internal::runtime::UpbGetArena::get_arena(&mut dst, ::protobuf::__internal::Private);
    let src_raw = ::protobuf::__internal::runtime::UpbGetMessagePtr::get_raw_message(&self, ::protobuf::__internal::Private);
...
impl<'msg> ::protobuf::IntoProxied<Quaternion> for QuaternionMut<'msg> {
  fn into_proxied(self, _private: ::protobuf::__internal::Private) -> Quaternion {
    ::protobuf::IntoProxied::into_proxied(::protobuf::IntoView::into_view(self), _private)
  }
}

impl ::protobuf::__internal::runtime::UpbTypeConversions for Quaternion {
    fn upb_type() -> ::protobuf::__internal::runtime::CType {
        ::protobuf::__internal::runtime::CType::Message
    }
    ...
    unsafe fn from_message_mut<'msg>(msg: ::protobuf::__internal::runtime::RawMessage, arena: &'msg ::protobuf::__internal::runtime::Arena)
        -> QuaternionMut<'msg> {
        let inner = unsafe { ::protobuf::__internal::runtime::MessageMutInner::<'msg, Quaternion>::wrap_raw(msg, arena) };
        QuaternionMut::new(::protobuf::__internal::Private, inner)
    }
}

#[allow(dead_code)]
#[allow(non_camel_case_types)]
pub struct QuaternionMut<'msg> {
  inner: ::protobuf::__internal::runtime::MessageMutInner<'msg, Quaternion>,
}

impl<'msg> ::protobuf::__internal::SealedInternal for QuaternionMut<'msg> {}

impl<'msg> ::protobuf::MessageMut<'msg> for QuaternionMut<'msg> {
  type Message = Quaternion;
}

impl ::std::fmt::Debug for QuaternionMut<'_> {
  fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
    let string = unsafe {
      ::protobuf::__internal::runtime::debug_string(
        self.raw_msg(),
...
impl ::protobuf::Serialize for QuaternionMut<'_> {
  fn serialize(&self) -> ::std::result::Result<Vec<u8>, ::protobuf::SerializeError> {
    ::protobuf::AsView::as_view(self).serialize()
  }
}
...
impl<'msg> QuaternionMut<'msg> {
  ...
  #[doc(hidden)]
  pub fn new(_private: ::protobuf::__internal::Private, inner: ::protobuf::__internal::runtime::MessageMutInner<'msg, Quaternion>) -> Self {
    Self { inner }
  }
  ...
  #[doc(hidden)]
  pub fn as_message_mut_inner(&mut self, _private: ::protobuf::__internal::Private)
    -> ::protobuf::__internal::runtime::MessageMutInner<'msg, Quaternion> {
    self.inner
  }
...
// SAFETY:
// - `QuaternionMut` does not perform any shared mutation.
// - `QuaternionMut` is not `Send`, and so even in the presence of mutator
//   splitting, synchronous access of an arena is impossible.
unsafe impl Sync for QuaternionMut<'_> {}

impl<'msg> ::protobuf::Proxy<'msg> for QuaternionMut<'msg> {}
impl<'msg> ::protobuf::MutProxy<'msg> for QuaternionMut<'msg> {}

impl<'msg> ::protobuf::AsView for QuaternionMut<'msg> {
  type Proxied = Quaternion;
  fn as_view(&self) -> ::protobuf::View<'_, Quaternion> {
    QuaternionView {
      inner: ::protobuf::__internal::runtime::MessageViewInner::view_of_mut(self.inner.clone()),
      _phantom: ::std::marker::PhantomData
    }
...
impl<'msg> ::protobuf::IntoView<'msg> for QuaternionMut<'msg> {
  fn into_view<'shorter>(self) -> ::protobuf::View<'shorter, Quaternion>
  where
      'msg: 'shorter {
    QuaternionView {
      inner: ::protobuf::__internal::runtime::MessageViewInner::view_of_mut(self.inner.clone()),
...
impl<'msg> ::protobuf::AsMut for QuaternionMut<'msg> {
  type MutProxied = Quaternion;
  fn as_mut(&mut self) -> QuaternionMut<'msg> {
    QuaternionMut { inner: self.inner }
  }
}

impl<'msg> ::protobuf::IntoMut<'msg> for QuaternionMut<'msg> {
  fn into_mut<'shorter>(self) -> QuaternionMut<'shorter>
  where
      'msg: 'shorter {
    self
  }
...
impl Quaternion {
  ...
  #[doc(hidden)]
  pub fn as_message_mut_inner(&mut self, _private: ::protobuf::__internal::Private) -> ::protobuf::__internal::runtime::MessageMutInner<'_, Quaternion> {
    ::protobuf::__internal::runtime::MessageMutInner::mut_of_owned(&mut self.inner)
  }
  ...
  pub fn as_view(&self) -> QuaternionView {
    QuaternionView::new(
        ::protobuf::__internal::Private,
        ::protobuf::__internal::runtime::MessageViewInner::view_of_owned(&self.inner))
  }

  pub fn as_mut(&mut self) -> QuaternionMut {
    let inner = ::protobuf::__internal::runtime::MessageMutInner::mut_of_owned(&mut self.inner);
    QuaternionMut::new(::protobuf::__internal::Private, inner)
  }
...
impl ::std::ops::Drop for Quaternion {
  fn drop(&mut self) {
  }
}
...
impl ::protobuf::AsView for Quaternion {
  type Proxied = Self;
  fn as_view(&self) -> QuaternionView {
    self.as_view()
  }
}

impl ::protobuf::AsMut for Quaternion {
  type MutProxied = Self;
  fn as_mut(&mut self) -> QuaternionMut {
    self.as_mut()
  }
}

unsafe impl ::protobuf::__internal::runtime::AssociatedMiniTable for Quaternion {
  fn mini_table() -> *const ::protobuf::__internal::runtime::upb_MiniTable {
    static ONCE_LOCK: ::std::sync::OnceLock<::protobuf::__internal::runtime::MiniTablePtr> =
        ::std::sync::OnceLock::new();
    ONCE_LOCK.get_or_init(|| unsafe {
      super::Proto__Quaternion_msg_init.0 =
          ::protobuf::__internal::runtime::upb_MiniTable_Build(
              "$!P!P!P!P".as_ptr(),
              9,
              ::protobuf::__internal::runtime::THREAD_LOCAL_ARENA.with(|a| a.raw()),
      ...
      assert!(::protobuf::__internal::runtime::upb_MiniTable_Link(
          ...
          submessages.as_ptr() as *const *const ::protobuf::__internal::runtime::upb_MiniTable,
          submessages.len(), subenums.as_ptr(), subenums.len()));
      ::protobuf::__internal::runtime::MiniTablePtr(super::Proto__Quaternion_msg_init.0)
    }).0
  }
}
unsafe impl ::protobuf::__internal::runtime::UpbGetArena for Quaternion {
  fn get_arena(&mut self, _private: ::protobuf::__internal::Private) -> &::protobuf::__internal::runtime::Arena {
    self.inner.arena()
  }
}

unsafe impl ::protobuf::__internal::runtime::AssociatedMiniTable for QuaternionView<'_> {
  #[inline(always)]
  fn mini_table() -> *const ::protobuf::__internal::runtime::upb_MiniTable {
    <Quaternion as ::protobuf::__internal::runtime::AssociatedMiniTable>::mini_table()
  }
}

unsafe impl ::protobuf::__internal::runtime::AssociatedMiniTable for QuaternionMut<'_> {
  #[inline(always)]
  fn mini_table() -> *const ::protobuf::__internal::runtime::upb_MiniTable {
    <Quaternion as ::protobuf::__internal::runtime::AssociatedMiniTable>::mini_table()
  }
}
unsafe impl ::protobuf::__internal::runtime::UpbGetMessagePtrMut for Quaternion {
  type Msg = Quaternion;
  fn get_ptr_mut(&mut self, _private: ::protobuf::__internal::Private) -> ::protobuf::__internal::runtime::MessagePtr<Quaternion> {
    self.inner.ptr_mut()
  }
}
unsafe impl ::protobuf::__internal::runtime::UpbGetMessagePtr for Quaternion {
  type Msg = Quaternion;
  fn get_ptr(&self, _private: ::protobuf::__internal::Private) -> ::protobuf::__internal::runtime::MessagePtr<Quaternion> {
    self.inner.ptr()
  }
}
unsafe impl ::protobuf::__internal::runtime::UpbGetMessagePtrMut for QuaternionMut<'_> {
  type Msg = Quaternion;
  fn get_ptr_mut(&mut self, _private: ::protobuf::__internal::Private) -> ::protobuf::__internal::runtime::MessagePtr<Quaternion> {
    self.inner.ptr_mut()
  }
}
unsafe impl ::protobuf::__internal::runtime::UpbGetMessagePtr for QuaternionMut<'_> {
  type Msg = Quaternion;
  fn get_ptr(&self, _private: ::protobuf::__internal::Private) -> ::protobuf::__internal::runtime::MessagePtr<Quaternion> {
    self.inner.ptr()
  }
}
unsafe impl ::protobuf::__internal::runtime::UpbGetMessagePtr for QuaternionView<'_> {
  type Msg = Quaternion;
  fn get_ptr(&self, _private: ::protobuf::__internal::Private) -> ::protobuf::__internal::runtime::MessagePtr<Quaternion> {
    self.inner.ptr()
  }
...
unsafe impl ::protobuf::__internal::runtime::UpbGetArena for QuaternionMut<'_> {
  fn get_arena(&mut self, _private: ::protobuf::__internal::Private) -> &::protobuf::__internal::runtime::Arena {
    self.inner.arena()
  }
}
...
// upb kernel doesn't support any owned message or message mut interop.
impl ::protobuf::OwnedMessageInterop for Quaternion {}
impl<'a> ::protobuf::MessageMutInterop<'a> for QuaternionMut<'a> {}

impl<'a> ::protobuf::MessageViewInterop<'a> for QuaternionView<'a> {
  unsafe fn __unstable_wrap_raw_message(
    msg: &'a *const ::std::ffi::c_void) -> Self {
    let raw = ::protobuf::__internal::runtime::RawMessage::new(*msg as *mut _).unwrap();
    let inner = unsafe { ::protobuf::__internal::runtime::MessageViewInner::wrap_raw(raw) };
